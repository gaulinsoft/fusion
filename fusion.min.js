...
arguments)))return!1;var d=b.styleChain,k=this.styleChain;if((k&&k.length||0)!=(d&&d.length||0)||!this._token!=!b._token||this._token&&!this._token.equals(b._token))return!1;if(k)for(var l=0,n=k.length;l<n;l++)if(!k[l].equals(d[l]))return!1;return!0},!0);n(p,"hack",function(){if(this.styleChain)return!1;r.hack.apply(this,arguments);var b=this.language;this.styleChain="fjs"==b||"fhtml"==b||"fcss"==b?[]:null;return!!this.styleChain},!0);n(p,"next",function(){var b=this.token,d=this._token||r.next.apply(this,
arguments),k=this.styleChain;if(!d)return null;var l=d.type;this._token||"HTMLDOCTYPEOpen"!=l?this._token&&(this._token=null):(this._token=d.clone(),this._token.start++,this._token.type="HTMLDOCTYPEDeclaration",d.end=d.start+1);if(!k)return d;if(!w(l,"CSS")){if(!b||!w(b.type,"CSS")||"FusionObjectSubstitutionOpen"==l||"FusionSelectorSubstitutionOpen"==l||"FusionStyleSubstitutionOpen"==l)return d;b=null;do{if(!k.length)break;b=k.pop()}while(b&&"*"!=b);return d}if(J(l)||N(l))return d;b&&(w(b.type,"CSS")||
"FusionObjectSubstitutionClose"==b.type||"FusionSelectorSubstitutionClose"==b.type||"FusionStyleSubstitutionClose"==b.type)||k.push("*");"FusionObjectOpen"==b.type&&k.push("*{");var n=k.length-1,m=0<=n?k[n]:null,a="CSSPunctuator"==l?d.text():null;if("{"==a)"@"==m?k[n]=m+"{":k.push("*{");else if("}"==a)m&&"*"!=m&&k.pop();else if("CSSSemicolon"==l)"*{:"==m||"@{:"==m?k[n]=m[0]+"{":"@"==m&&k.pop();else if("CSSColon"!=l||"*{"!=m&&"@{"!=m){if(n="@{"==m&&"CSSIdentifier"==l?this.peek(d.end):null,"CSSAtKeyword"!=
l||"*"!=m&&"*{"!=m&&"@{"!=m?d.type="*{"==m&&"CSSIdentifier"==l||n&&"CSSColon"==n.type?"CSSDeclarationName":"*{:"==m||"@{:"==m?"CSSDeclarationValue":"*"==m||"@{"==m?"CSSSelector":"@"==m?"CSSAtRule":"CSSInvalidCharacters":(k.push("@"),d.type="CSSAtRule"),"*{:"==m||"@{:"==m)"CSSDelimiter"==l&&"!"==d.text()?(n=this.peek(d.end))&&"CSSIdentifier"==n.type&&"important"==n.text().toLowerCase()&&(n=this.peek(n.end))&&("CSSSemicolon"==n.type||"CSSPunctuator"==n.type&&"}"==n.text())&&(d.type="CSSDeclarationImportant"):
b&&"CSSDelimiter"==b.type&&"!"==b.text()&&"CSSIdentifier"==l&&"important"==d.text().toLowerCase()&&(n=this.peek(d.end))&&("CSSSemicolon"==n.type||"CSSPunctuator"==n.type&&"}"==n.text())&&(d.type="CSSDeclarationImportant")}else k[n]=m+":";return d},!0);n(p,"reset",function(){r.reset.apply(this,arguments);this.styleChain=this._token=null},!0);p=function(){};(p.prototype=O(r))._clone=p;F("highlight",function(b,d,k){b=new R(b,d||"fjs");d="";var l=null;for(k||b.hack();l=b.next();)d+=l.html();return d});
F("parse",function(b,d,k){});F("tokenize",function(b,d,k){b=new H(b,d||"fjs");d=null;var l=[];for(k||b.hack();d=b.next();)l.push({type:d.type,start:d.start,end:d.end});return l});F("transpile",function(b,d,k,l,n,m){b=new H(b,"fjs");for(var a="",e=null,h=null,p=[],r=function(a,b){return b.toUpperCase()};e=b.next();){if("FusionSelectorOpen"==e.type||"FusionSelectorSubstitutionClose"==e.type){var f="",q="FusionSelectorOpen"==e.type,g=!0;do if("FusionSelectorSubstitutionOpen"==e.type)h=b.peek(),h&&"JavaScriptPunctuator"==
h.type&&"}"==h.text()||(f+='"+(',g=!1),h=b.token;else if("FusionSelectorSubstitutionClose"==e.type)h&&"FusionSelectorSubstitutionOpen"==h.type||(f+=')+"',g=!0),h=b.token;else{if(!w(e.type,"CSS")&&"FusionSelectorOpen"!=e.type&&"FusionSelectorClose"!=e.type)break;N(e.type)||(h="FusionSelectorOpen"==e.type?e.text().substr(1):e.text(),f+=h.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n\\\n"),h=b.token)}while(e=b.next());var s=/^\(\s*(head|html|body)\s*\)$/i.exec(f);s?(f=s[1].toLowerCase(),
a+="document."+("html"==f?"documentElement":f)):(a+=q?"["==f[0]?(l||"document.__query")+'("':(k||"document.__find")+'("':')+"',a+=f.substr(q?1:0,f.length-(q&&g?2:1)),g&&(a+='")'))}else if("FusionObjectOpen"==e.type||"FusionObjectSubstitutionClose"==e.type){f="FusionObjectOpen"!=e.type;do if("FusionObjectSubstitutionOpen"==e.type)h&&"CSSColon"==h.type&&(a+='"'),(h=b.peek())&&"JavaScriptPunctuator"==h.type&&"}"==h.text()||(a+='"+('),h=b.token;else if("FusionObjectSubstitutionClose"==e.type)h&&"FusionObjectSubstitutionOpen"==
h.type||(a+=')+"'),h=b.token;else{if(!w(e.type,"CSS")&&"FusionObjectOpen"!=e.type&&"FusionObjectClose"!=e.type)break;if(!N(e.type)){if(q=J(e.type)?e:null)if(e=b.next(),!e){a+=q.text();break}if(f){if("FusionObjectClose"==e.type&&"fjs"==b.state){h&&"CSSSemicolon"==h.type||(a+='"');q&&(a+=q.text());a+=e.text();h=b.token;continue}else if("CSSSemicolon"==e.type){a+='"';f=!1;q&&(a+=q.text());h=b.token;continue}else q&&(a+=q.text().replace(/\n/g,"\\n\\\n"));"FusionObjectSubstitutionOpen"==e.type?(h=b.peek())&&
"JavaScriptPunctuator"==h.type&&"}"==h.text()||(a+='"+('):"FusionObjectSubstitutionClose"==e.type?h&&"FusionObjectSubstitutionOpen"==h.type||(a+=')+"'):a+=e.text().replace(/\\/g,"\\\\").replace(/"/g,'\\"')}else"CSSIdentifier"!=e.type||!h||"FusionObjectOpen"!=h.type&&"CSSSemicolon"!=h.type?"CSSColon"==e.type?(q&&(a+=q.text()),a+=e.text()):"CSSSemicolon"==e.type?q&&(a+=q.text()):h&&"CSSColon"==h.type?(q&&(a+=q.text()),f=!0,"fjs"!=b.state&&(a+='"'),"FusionObjectSubstitutionOpen"==e.type?(h=b.peek())&&
"JavaScriptPunctuator"==h.type&&"}"==h.text()||(a+='"+('):"FusionObjectSubstitutionClose"==e.type?h&&"FusionObjectSubstitutionOpen"==h.type||(a+=')+"'):a+=e.text().replace(/\\/g,"\\\\").replace(/"/g,'\\"')):(q&&(a+=q.text()),a+="FusionObjectOpen"==e.type?e.text().substr(1):e.text()):("CSSSemicolon"==h.type&&(a+=","),q&&(a+=q.text()),a+='"',a+=e.text().replace(/^-+/,"").replace(/-+([a-z])/ig,r),a+='"');h=b.token}}while(e=b.next())}if(!e)break;if("FusionProperty"==e.type)a+=".__"+e.text().substr(1);
else if("FusionSubstitutionOpen"==e.type||"FusionStyleSubstitutionOpen"==e.type)a+='"+(';else if("FusionSubstitutionClose"==e.type||"FusionStyleSubstitutionClose"==e.type)a+=')+"';else if("HTMLStartTagOpen"==e.type)p.length&&(a+=e.text());else if("HTMLStartTagName"==e.type)f=e.text(),p.push(f),f=f.replace(/\\/g,"\\\\").replace(/"/g,'\\"'),a+=1<p.length?f:(d||"document.__create")+'("'+f+'")';else if(p.length)if("HTMLStartTagClose"==e.type)!h||"HTMLAttributeName"!=h.type&&"HTMLAttributeOperator"!=h.type?
!h||"FusionAttributeTemplateString"!=h.type&&"FusionAttributeTemplateStringTail"!=h.type||(a+=")"):a+='"")',f=p[p.length-1],"area"==f||"base"==f||"br"==f||"col"==f||"embed"==f||"hr"==f||"img"==f||"input"==f||"keygen"==f||"link"==f||"menuitem"==f||"meta"==f||"param"==f||"source"==f||"track"==f||"wbr"==f?(p.pop(),p.length&&(a+=e.text())):a+=1<p.length?e.text():"."+(m||"__html")+'("';else if("HTMLEndTagOpen"==e.type)a+=1<p.length?e.text():'")';else if("HTMLEndTagName"==e.type){f=e.text();if(f!=p[p.length-
1])throw"unmatched <"+p[p.length-1]+"> tag";1<p.length&&(a+=f.replace(/\\/g,"\\\\").replace(/"/g,'\\"'))}else if("HTMLStartTagSelfClose"==e.type||"HTMLEndTagClose"==e.type||"HTMLEndTagSelfClose"==e.type)"HTMLStartTagSelfClose"==e.type&&h&&"HTMLAttributeName"==h.type?a+='"")':"HTMLStartTagSelfClose"!=e.type||!h||"FusionAttributeTemplateString"!=h.type&&"FusionAttributeTemplateStringTail"!=h.type||(a+=")"),p.pop(),p.length&&(a+=e.text());else if(1==p.length&&"HTMLAttributeName"==e.type)h&&"HTMLAttributeName"==
h.type?a+='"")':!h||"FusionAttributeTemplateString"!=h.type&&"FusionAttributeTemplateStringTail"!=h.type||(a+=")"),a+="."+(n||"__attr")+'("',a+=e.text().replace(/\\/g,"\\\\").replace(/"/g,'\\"'),a+='",';else if(1==p.length&&("HTMLAttributeValue"==e.type||"HTMLAttributeDoubleQuotedValue"==e.type||"HTMLAttributeSingleQuotedValue"==e.type)){f=e.text();"HTMLAttributeValue"!=e.type&&(f=f.substr(1,f.length-2));a+='"';e=0;for(q=f.length;e<q;){g=f[e];if("&"==g)if(h=f[e+1],"#"==h)if(h=f[e+2],"x"==h||"X"==
h){if(h=f[e+3],x(h)){e+=3;h="";do{g=f[e];if(!x(g))break;h+=g}while(++e<q);for(";"!=f[e++]&&e--;4>h.length;)h="0"+h;a+="\\u";a+=h;continue}}else{if("0"<=h&&"9">=h){e+=2;h="";do{g=f[e];if("0">g||"9"<g)break;h+=g}while(++e<q);";"!=f[e++]&&e--;for(h=ba(h,10).toString(16);4>h.length;)h="0"+h;a+="\\u";a+=h;continue}}else{if(z(h)){e++;h="&";do{g=f[e];if(!M(g))break;h+=g}while(++e<q);";"!=f[e++]?e--:h+=";";g=Q[h.substr(1)];V(g)?g="\\u"+S(g[0],4,"0")+"\\u"+S(g[1],4,"0"):g&&(g="\\u"+S(g,4,"0"));a+=g?g:h;continue}}else if('"'==
g){a+='\\"';e++;continue}else if("\n"==g){a+="\\n\\\n";e++;continue}else if("\\"==g){a+="\\\\";e++;continue}a+=g;e++}a+='")'}else if(1==p.length&&"HTMLStartTagSolidus"==e.type)h&&"HTMLAttributeName"==h.type?a+='"")':!h||"FusionAttributeTemplateString"!=h.type&&"FusionAttributeTemplateStringTail"!=h.type||(a+=")");else if("FusionAttributeTemplateString"==e.type||"FusionAttributeTemplateStringHead"==e.type||"FusionAttributeTemplateStringMiddle"==e.type||"FusionAttributeTemplateStringTail"==e.type){f=
e.text();e="`"==f[0];q="`"==f[f.length-1];if(e)a+='"';else if(!h||"FusionAttributeTemplateStringHead"!=h.type&&"FusionAttributeTemplateStringMiddle"!=h.type||"`"==h.source[h.end-1])a+=')+"';a+=f.substr(1,q?f.length-2:f.length-3).replace(/"/g,'\\"').replace(/\n/g,"\\n\\\n");q?a+='"':(h=b.peek())&&"JavaScriptPunctuator"==h.type&&"}"==h.text()||(a+='"+(')}else if("HTMLText"==e.type||w(e.type,"CSS"))a+=e.text().replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n\\\n");else if("HTMLStartTagWhitespace"==
